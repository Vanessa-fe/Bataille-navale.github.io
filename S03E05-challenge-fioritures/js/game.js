...
let game = {
    ...
    // initialisée à 1
    nbRound : 1,
    // Mémorise le score tout au long de la partie
    // initialisé à 0
    score : 0,
    ...
    sendMissileAt : function (rowIndex, columIndex)
    {
        ...
        if (targetCell === 'b' ) {
            ...
            game.nbRound ++ ;
            // Quand on réussit un tir, on gagne 30000 pts
            game.score += 30000;
        ...
        // ---- TIR RATE ----
            ...
            // tant pis, si la case avait déjà été ciblée auparavant
            game.nbRound ++ ;
            // tir raté : on retire au score 9000 pts
            game.score -= 9000;
            return false;
    ...
    isOver : function () {
        // si on joue en cliquant directement sur les cases, alors, il faudra penser à retirer tous les écouteurs d'évéments sur les cases
